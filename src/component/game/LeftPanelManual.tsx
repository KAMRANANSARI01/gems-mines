  ...
  return (
    <aside className="w-full h-full flex flex-col  ">
      ...
      <div className="mb-[5px]">
        <div className="text-sm text-gray-300 mb-1  font-semibold flex items-center gap-x-1">
          Amount <AiOutlineInfoCircle color="#1aa964" />
        </div>
        ...
        {gameStatus === "idle" ? (
          ...
          <>
            ...
            <button
              ...
              className={`cashout_btn flex justify-center items-center gap-x-1  opacity-90 font-medium ${
                !firstTileRevealed
